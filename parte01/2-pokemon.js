/**
* 1- Crie um programa que simule um ataque do meuPokemon contra o pokemonInimigo.
...
*
* 2- Crie também uma simulação para determinar se o ataque atingiu o adversário,
* antes de considerar a simulação do dano do ataque. Considere que a chance de
* acerto de um golpe é de 75%.
*
*/
